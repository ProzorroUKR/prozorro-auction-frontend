angular.module('auction').config(
    ...
    'Bidder Coefficient':'Coefficient:',
    ...
    'Auction was completed': 'Auction was completed on',
    ...
    'Maximum contract duration is 15 years': 'Maximum contract duration is 15 years',
  ...
  $translateProvider.translations('uk', {
    ...
    'Auction was completed': 'Аукціон завершився',
    ...
    'Unable to place a bid. Check that no more than 2 auctions are simultaneously opened in your browser.': 'Не вдається зробити ставку. Перевірте, що в браузері відкрито не більше 2-х аукціонів.',
    ...
    'Maximum contract duration is 15 years': 'Максимальна тривалість контракту становить 15 років',
  ...
  $translateProvider.translations('ru', {
    ...
    'seconds': 'сек',
    'minimum': 'минимум',
    'Internet connection is lost. Attempt to restart after 1 sec': 'Соединение с интернетом потеряно. Попытка перезагрузки через 1 сек',
    'Synchronization failed': 'Ошибка синхронизации',
    'Possible results': 'Возможные результаты',
    'In the room came a new user': 'В кабинет зашёл новый пользователь',
    ...
    'Auction was completed': 'Аукцион закончился',
    ...
    "Your post bid request still hasn't succeed. Check (or change) your internet connection, browser or device.": "Ваш запрос ставки всё ещё не был доставлен. Проверьте (или измените) ваше интернет-подключение, браузер или устройство.",
    ...
    'maximum': 'максимум',
    'Step augmentation of Bid': 'Шаг увеличения торгов',
    ...
    'Maximum contract duration is 15 years': 'Максимальная продолжительность контракта составляет 15 лет',
    'Amount NPV: Too low value': 'Сумма ПЕД: Слишком низкое значение',
    'No bidder id': 'Не найден id участника',
